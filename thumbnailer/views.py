...
class HomeView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            task = make_thumbnails.delay(file_path, thumbnails=[(128, 128), (256, 256)])

            context['task_id'] = task.id
            context['task_status'] = task.status

            return render(request, 'thumbnailer/home.html', context=context)

        context['form'] = form

        return render(request, 'thumbnail/home.html', context=context)
